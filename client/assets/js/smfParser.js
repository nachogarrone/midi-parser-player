...
class SmfParser {
  ...
  parse(data) {
    ...
    const headerStream = this.Stream(headerChunk.data);
    ...
    for (let i = 0; i < header.trackCount; i++) {
      ...
      const trackStream = this.Stream(trackChunk.data);
      this.totalTime=0;
    ...
    if ((eventTypeByte & 0xf0) == 0xf0) {
      ...
      switch (eventType) {
        ...
        case 0x0e:
          ...
          const msb=event.value & 0x7f;
          const lsb=event.value >>> 7;
